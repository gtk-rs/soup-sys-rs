...
pub const SOUP_AUTH_DOMAIN_BASIC_H: c_int = 1;
...
pub const SOUP_AUTH_DOMAIN_DIGEST_H: c_int = 1;
...
pub const SOUP_AUTH_DOMAIN_H: c_int = 1;
...
pub const SOUP_AUTH_MANAGER_H: c_int = 1;
...
pub const SOUP_CACHE_H: c_int = 1;
...
pub const SOUP_CONTENT_DECODER_H: c_int = 1;
pub const SOUP_CONTENT_SNIFFER_H: c_int = 1;
pub const SOUP_COOKIE_H: c_int = 1;
...
pub const SOUP_COOKIE_JAR_DB_H: c_int = 1;
pub const SOUP_COOKIE_JAR_H: c_int = 1;
...
pub const SOUP_COOKIE_JAR_TEXT_H: c_int = 1;
...
pub const SOUP_DATE_H: c_int = 1;
pub const SOUP_FORM_H: c_int = 1;
...
pub const SOUP_HEADERS_H: c_int = 1;
pub const SOUP_LOGGER_H: c_int = 1;
...
pub const SOUP_MESSAGE_BODY_H: c_int = 1;
...
pub const SOUP_MESSAGE_H: c_int = 1;
pub const SOUP_MESSAGE_HEADERS_H: c_int = 1;
...
pub const SOUP_METHOD_H: c_int = 1;
pub const SOUP_MICRO_VERSION: c_int = 1;
pub const SOUP_MINOR_VERSION: c_int = 56;
pub const SOUP_MISC_H: c_int = 1;
pub const SOUP_MULTIPART_H: c_int = 1;
pub const SOUP_MULTIPART_INPUT_STREAM_H: c_int = 1;
pub const SOUP_PASSWORD_MANAGER_H: c_int = 1;
pub const SOUP_PROXY_RESOLVER_DEFAULT_H: c_int = 1;
pub const SOUP_PROXY_URI_RESOLVER_H: c_int = 1;
pub const SOUP_REQUESTER_H: c_int = 1;
pub const SOUP_REQUEST_DATA_H: c_int = 1;
pub const SOUP_REQUEST_FILE_H: c_int = 1;
pub const SOUP_REQUEST_H: c_int = 1;
pub const SOUP_REQUEST_HTTP_H: c_int = 1;
...
pub const SOUP_SERVER_H: c_int = 1;
...
pub const SOUP_SESSION_ASYNC_H: c_int = 1;
pub const SOUP_SESSION_FEATURE_H: c_int = 1;
pub const SOUP_SESSION_H: c_int = 1;
...
pub const SOUP_SESSION_SYNC_H: c_int = 1;
...
pub const SOUP_SOCKET_H: c_int = 1;
...
pub const SOUP_STATUS_H: c_int = 1;
pub const SOUP_TYPES_H: c_int = 1;
pub const SOUP_URI_H: c_int = 1;
pub const SOUP_VALUE_UTILS_H: c_int = 1;
pub const SOUP_VERSION_MIN_REQUIRED: c_int = 2;
pub const SOUP_XMLRPC_H: c_int = 1;
pub const SOUP_XMLRPC_OLD_H: c_int = 1;

// Flags
bitflags! {
    #[repr(C)]
    pub struct SoupCacheability: c_uint {
        const CACHEABLE = 1;
        const UNCACHEABLE = 2;
        const INVALIDATES = 4;
        const VALIDATES = 8;
...
pub const SOUP_CACHE_CACHEABLE: SoupCacheability = SoupCacheability::CACHEABLE;
pub const SOUP_CACHE_UNCACHEABLE: SoupCacheability = SoupCacheability::UNCACHEABLE;
pub const SOUP_CACHE_INVALIDATES: SoupCacheability = SoupCacheability::INVALIDATES;
pub const SOUP_CACHE_VALIDATES: SoupCacheability = SoupCacheability::VALIDATES;

bitflags! {
    #[repr(C)]
    pub struct SoupExpectation: c_uint {
        const UNRECOGNIZED = 1;
        const CONTINUE = 2;
    }
}
pub const SOUP_EXPECTATION_UNRECOGNIZED: SoupExpectation = SoupExpectation::UNRECOGNIZED;
pub const SOUP_EXPECTATION_CONTINUE: SoupExpectation = SoupExpectation::CONTINUE;

bitflags! {
    #[repr(C)]
    pub struct SoupMessageFlags: c_uint {
        const NO_REDIRECT = 2;
        const CAN_REBUILD = 4;
...
pub const SOUP_MESSAGE_NO_REDIRECT: SoupMessageFlags = SoupMessageFlags::NO_REDIRECT;
pub const SOUP_MESSAGE_CAN_REBUILD: SoupMessageFlags = SoupMessageFlags::CAN_REBUILD;
pub const SOUP_MESSAGE_OVERWRITE_CHUNKS: SoupMessageFlags = SoupMessageFlags::OVERWRITE_CHUNKS;
pub const SOUP_MESSAGE_CONTENT_DECODED: SoupMessageFlags = SoupMessageFlags::CONTENT_DECODED;
pub const SOUP_MESSAGE_CERTIFICATE_TRUSTED: SoupMessageFlags = SoupMessageFlags::CERTIFICATE_TRUSTED;
pub const SOUP_MESSAGE_NEW_CONNECTION: SoupMessageFlags = SoupMessageFlags::NEW_CONNECTION;
pub const SOUP_MESSAGE_IDEMPOTENT: SoupMessageFlags = SoupMessageFlags::IDEMPOTENT;
pub const SOUP_MESSAGE_IGNORE_CONNECTION_LIMITS: SoupMessageFlags = SoupMessageFlags::IGNORE_CONNECTION_LIMITS;

bitflags! {
    #[repr(C)]
    pub struct SoupServerListenOptions: c_uint {
        const HTTPS = 1;
        const IPV4_ONLY = 2;
        const IPV6_ONLY = 4;
    }
}
pub const SOUP_SERVER_LISTEN_HTTPS: SoupServerListenOptions = SoupServerListenOptions::HTTPS;
pub const SOUP_SERVER_LISTEN_IPV4_ONLY: SoupServerListenOptions = SoupServerListenOptions::IPV4_ONLY;
pub const SOUP_SERVER_LISTEN_IPV6_ONLY: SoupServerListenOptions = SoupServerListenOptions::IPV6_ONLY;
...
impl ::std::fmt::Debug for SoupAddressClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAddressClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthDomainBasicClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthDomainBasicClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthDomainClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthDomainClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthDomainDigestClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthDomainDigestClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthManagerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthManagerClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthManagerPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthManagerPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupBuffer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupBuffer @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupCacheClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupCacheClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupCachePrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupCachePrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupClientContext {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupClientContext @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupConnection {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupConnection @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupContentDecoderClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupContentDecoderClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupContentDecoderPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupContentDecoderPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupContentSnifferClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupContentSnifferClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupContentSnifferPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupContentSnifferPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupCookie {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupCookie @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupCookieJarClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupCookieJarClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupCookieJarDBClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupCookieJarDBClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupCookieJarTextClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupCookieJarTextClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupDate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupDate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupLoggerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupLoggerClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMessageBody {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMessageBody @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMessageClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMessageClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMessageHeaders {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMessageHeaders @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMessageHeadersIter {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMessageHeadersIter @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMessageQueue {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMessageQueue @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMessageQueueItem {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMessageQueueItem @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMultipart {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMultipart @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMultipartInputStreamClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMultipartInputStreamClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupMultipartInputStreamPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupMultipartInputStreamPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupPasswordManagerInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupPasswordManagerInterface @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupProxyResolverDefaultClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupProxyResolverDefaultClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupProxyURIResolverInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupProxyURIResolverInterface @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRange {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRange @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestDataClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestDataClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestDataPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestDataPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestFileClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestFileClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestFilePrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestFilePrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestHTTPClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestHTTPClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestHTTPPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestHTTPPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequestPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequestPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequesterClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequesterClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupRequesterPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupRequesterPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupServerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupServerClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupSessionAsyncClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupSessionAsyncClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupSessionClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupSessionClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupSessionFeatureInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupSessionFeatureInterface @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupSessionSyncClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupSessionSyncClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupSocketClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupSocketClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupURI {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupURI @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupWebsocketConnectionClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupWebsocketConnectionClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupWebsocketConnectionPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupWebsocketConnectionPrivate @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupXMLRPCParams {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupXMLRPCParams @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthBasic {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthBasic @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthDigest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthDigest @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthNTLM {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthNTLM @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for SoupAuthNegotiate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "SoupAuthNegotiate @ {:?}", self as *const _)
    }
}
